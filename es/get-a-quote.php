    ...
    <div class="row justify-center items-center">
        <div class="col-lg-8 mx-auto">
            ...
            <form action="./request_backend" method="POST" enctype="multipart/form-data" id="discoveryForm">
                ...
                <div class="section p-3" id="dev_section">
                ...
                <div class="section p-3" id="marketing_section">
                ...
                <div class="section p-3" id="step4">
        ...
        <div class="col-lg-4 mx-auto">
            <div class="card p-4 p-md-5 shadow-sm border-0" style="border-radius: 16px;">
                <h3 class="fw-bold mb-3" style="color:#001f3f;">
                    Grow Your Business Online 🚀
                </h3>

                <p class="text-secondary mb-4">
                    Build a powerful digital presence with <strong>EseSphere Limited</strong>.
                    We deliver high-quality digital solutions that help your business attract
                    customers and scale effectively.
                </p>

                <ul class="list-unstyled mb-0">
                    <li class="mb-2">✔️ Modern Website Development</li>
                    <li class="mb-2">✔️ Mobile App Development (iOS & Android)</li>
                    <li class="mb-2">✔️ Digital Marketing & Social Media Management</li>
                    <li class="mb-2">✔️ Branding & Creative Design</li>
                </ul>
            </div>
        </div>
    </div>
